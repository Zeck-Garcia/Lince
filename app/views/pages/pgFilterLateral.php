...
<div class="offcanvas offcanvas-start d-lg-none" tabindex="-1" id="menuMobile">
    ...
    <div class="offcanvas-body p-0 d-flex flex-column">
        ...
        <div class="sidebar-footer">
            <a href="#" class="btn btn-outline-danger w-100"><i class="bi bi-box-arrow-left me-2"></i> Sair</a>
        </div>
    </div>
</div>
...
<aside class="sidebar-desktop d-none d-lg-flex">
    <div class="p-4 text-center border-bottom">
        ...
        <h6 class="mb-0 fw-bold">ADMINUSER</h6>
    ...
    <div class="py-3">
        <ul class="nav flex-column">
            <?php
                ...
                //rh
                 if(in_array($_SESSION["classeAgente"], [4])){
                    echo "<li class='nav-item'><a href='recursoHumano/formacao' class='nav-link'><i class='bi bi-alarm'></i>Formação</a></li>";

                    echo "<li class='nav-item'><a href='recursoHumano/calculo-hora' class='nav-link'><i class='bi bi-alarm'></i>Calculo de Hora</a></li>";
                }

                //adm e user
                if(in_array($_SESSION["classeAgente"], [1,2])){
                    echo "<li class='nav-item'><a href='adm/utilizadores' class='nav-link'><i class='bi bi-cart-check'></i> &nbsp Utilizadores</a></li>";

                    echo "<li class='nav-item'><a href='adm/ordem-compra' class='nav-link'><i class='bi bi-cart-check'></i> &nbsp Ordem de Compra</a></li>";
                }
            ?>
        </ul>
    </div>
    ...
    <div class="sidebar-footer">
        <a href="#" class="btn btn-outline-danger w-100 border-0"><i class="bi bi-box-arrow-left me-2"></i> Sair do Sistema</a>
    </div>
</aside>