                        ...
                        <div class="">
                            ...
                            <div class="input-group">
                                <div class="form-floating">
                                  <input type="text" id="txtNomeCurso" class="form-control" placeholder="">
                                  <label>Titulo da formação</label>
                                </div>
                                <button id="btnSearchCurso" class="btn btn-primary" onclick="monteLoadListTableCurso(0)"><i class="bi bi-search"></i></button>
                                <button id="btnSaveCurso" class="btn btn-success"><i class="bi bi-plus-circle"></i></button>
                            </div>
