                        ...
                        <div class="">
                            ...
                            <div class="input-group">
                                <div class="form-floating">
                                  <input type="text" id="txtNomeLocal" class="form-control" placeholder="">
                                  <label>Titulo da formação</label>
                                </div>
                                <button id="btnSearchLocal" class="btn btn-primary" onclick="monteLoadListTableLocal(0)"><i class="bi bi-search"></i></button>
                                <button id="btnSaveLocal" class="btn btn-success"><i class="bi bi-plus-circle"></i></button>
                            </div>
