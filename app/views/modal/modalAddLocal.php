                        ...
                        <div class="">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="CampoGroup w-100">
                                  <input type="text" id="txtNomeLocal" class="form-control">
                                  <label>Titulo da formação</label>
                                </div>
                                <button id="btnSearchLocal" class="btn btn-primary col-2 ms-2" onclick="monteLoadListTableLocal(0)"><i class="bi bi-search"></i></button>
                                <button id="btnSaveLocal" class="btn btn-success col-2 ms-2"><i class="bi bi-plus-circle"></i></button>
                            </div>
