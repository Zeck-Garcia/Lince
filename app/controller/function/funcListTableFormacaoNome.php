...
$operation = new manipulacaoDeDados();
    ...
    $select = "WITH result AS (SELECT * FROM tbFormacaoNome ORDER BY nomeFormacaoNome ASC)
    SELECT *, (SELECT COUNT(*) FROM result) AS totalRegistro FROM result ORDER BY nomeFormacaoNome ASC LIMIT ?, ?";
    $type = "ii";
    $param = [$inicio, $limite];
